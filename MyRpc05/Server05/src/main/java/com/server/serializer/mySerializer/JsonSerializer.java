package com.server.serializer.mySerializer;
            ...
            case 0:
                ...
                for(int i = 0; i < objects.length; i++){
                    ...
                    if (!paramsType.isAssignableFrom(request.getParams()[i].getClass())){
                        //如果不一致，就行进行类型转换
                        System.out.println("request.getParams()[i]"+request.getParams()[i]+"===request.getParamsTypes()[i]"+request.getParamsTypes()[i]);
